...
const IdleCharacter = ({ isDark = true }) => {
    ...
    const C = isDark ? {
        ...
        accent: '#E04C18',
        devGlow: '#FF8C00',
        circuit: 'rgba(192,120,56,.35)',
        badgeBg: 'rgba(28,34,38,.65)',
        eyeGlow: '#FF6B00',
        visorLine: 'rgba(220,160,80,.7)',
        visorFill: 'rgba(192,120,56,.14)',
        dust: 'rgba(192,120,56,.45)',
        glowFx: 'drop-shadow(0 0 10px rgba(192,120,56,.5)) drop-shadow(0 2px 3px rgba(0,0,0,.45))',
        bubbleBg: '#FFFFFF',
        bubbleTxt: '#1C2226',
    };
