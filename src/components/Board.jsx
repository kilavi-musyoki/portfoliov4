...
const PCBBoard = ({ layer = 'casing', className = '', isDark = true }) => {
    ...
    // Light → Classic green PCB (bright green traces, gold pads, dark green substrate)
    const traceColor        = isDark ? '#4BD8A0'                  : '#00CC66';
    const traceColorDim     = isDark ? 'rgba(75,216,160,0.55)'    : 'rgba(0,204,102,0.55)';
    const traceGlow         = isDark ? 'rgba(75,216,160,0.4)'     : 'rgba(0,204,102,0.5)';
    const padColor          = isDark ? '#D4A843'                  : '#D4A843';  // gold pads same in both
    const padColorDim       = isDark ? 'rgba(212,168,67,0.4)'     : 'rgba(212,168,67,0.5)';
    const padColorMuted     = isDark ? 'rgba(212,168,67,0.7)'     : 'rgba(212,168,67,0.8)';
    const pcbSubstrate      = isDark ? '#1a2e1a'                  : '#0d2b1a';  // deep PCB green
    const pcbBorder         = isDark ? 'rgba(75,216,160,0.4)'     : 'rgba(0,204,102,0.5)';
    const casingFill        = isDark ? '#2a2a2a'                  : '#1e2e1e';  // dark green casing
    const casingStroke      = isDark ? '#444'                     : '#2e4a2e';
    const casingInner       = isDark ? '#222'                     : '#152415';
    const casingInnerStroke = isDark ? '#333'                     : '#1e3a1e';
    ...
    const silkLabel         = isDark ? 'rgba(255,255,255,0.18)'   : 'rgba(255,255,255,0.22)';
    ...
    const usbInner          = isDark ? '#111'                     : '#0d1f0d';
    ...
    const tooltipPartColor  = isDark ? '#D4A843'                  : '#D4A843';
    const tooltipOwner      = isDark ? 'rgba(75,216,160,0.5)'     : 'rgba(0,204,102,0.7)';
    const dieBg             = isDark ? '#000810'                  : '#050f05';
    const dieGrid           = isDark ? 'rgba(0,255,136,0.15)'     : 'rgba(0,255,102,0.2)';
    const dieRing1          = isDark ? 'rgba(77,255,255,0.3)'     : 'rgba(0,255,102,0.4)';
    const dieRing2          = isDark ? 'rgba(0,255,136,0.4)'      : 'rgba(0,255,102,0.55)';
    const dieCenter         = isDark ? 'rgba(77,255,255,0.5)'     : 'rgba(0,255,102,0.65)';
    const dieLabel          = isDark ? 'rgba(77,255,255,0.5)'     : 'rgba(0,255,102,0.65)';
    const dieCellA          = isDark ? 'rgba(0,255,136,0.3)'      : 'rgba(0,255,102,0.35)';
    const dieCellB          = isDark ? 'rgba(77,255,255,0.1)'     : 'rgba(0,255,102,0.12)';
    const quantumBg         = isDark ? '#000005'                  : '#020d02';
    const quantumLabel1     = isDark ? 'rgba(77,255,255,0.6)'     : 'rgba(0,255,136,0.75)';
    const quantumLabel2     = isDark ? 'rgba(0,255,136,0.5)'      : 'rgba(0,204,102,0.7)';
    const glowStop1         = isDark ? '#4BD8A0'                  : '#00CC66';
    const glowStop2         = isDark ? '#4BD8A0'                  : '#00CC66';
    const qGlowA            = isDark ? '#6FD4FF'                  : '#00FF88';
    const qGlowB            = isDark ? '#4BD8A0'                  : '#00CC66';
    const qGlowC            = isDark ? '#FF5A3C'                  : '#D4A843';
    const dieGlowA          = isDark ? '#4DFFFF'                  : '#00FF88';
    const dieGlowB          = isDark ? '#00FF88'                  : '#00CC66';
    const thermalLabel      = isDark ? 'rgba(255,170,0,0.8)'      : 'rgba(212,168,67,0.9)';
    const resistorColor     = isDark ? '#8a6cd4'                  : '#7a6090';  // keep purple-ish
    const capColor          = '#D4A843';
    const capBodyColor      = isDark ? '#c8a82a'                  : '#c8a82a';
    const vregColor         = isDark ? '#2a4a2a'                  : '#0d2e0d';  // deep green IC body
